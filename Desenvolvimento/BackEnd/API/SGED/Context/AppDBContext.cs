...
public class AppDBContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Cidade>().HasData(
            new Cidade { Id = 1, NomeCidade = "Aparecida d'Oeste", IdEstado = 25 },
            new Cidade { Id = 2, NomeCidade = "Jales", IdEstado = 25 },
            new Cidade { Id = 3, NomeCidade = "Palmeira d'Oeste", IdEstado = 25 },
            new Cidade { Id = 4, NomeCidade = "Paranapuã", IdEstado = 25 },
            new Cidade { Id = 5, NomeCidade = "Rubineia", IdEstado = 25 },
            new Cidade { Id = 6, NomeCidade = "Santa Clara d'Oeste", IdEstado = 25 },
            new Cidade { Id = 7, NomeCidade = "Santa Fé do Sul", IdEstado = 25 },
            new Cidade { Id = 8, NomeCidade = "São Francisco", IdEstado = 25 },
            new Cidade { Id = 9, NomeCidade = "São João das Duas Pontes", IdEstado = 25 },
            new Cidade { Id = 10, NomeCidade = "Urânia", IdEstado = 25 }
        );
