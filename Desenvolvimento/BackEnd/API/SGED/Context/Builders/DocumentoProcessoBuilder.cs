...
namespace SGED.Context.Builders
{
    public class DocumentoProcessoBuilder
    {
        public static void Build(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<DocumentoProcessoModel>().Property(dp => dp.HashDocumento).HasMaxLength(64);
            modelBuilder.Entity<DocumentoProcessoModel>().Property(dp => dp.ArquivoDocumento);
