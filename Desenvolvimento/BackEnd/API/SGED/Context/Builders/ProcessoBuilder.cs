...
namespace SGED.Context.Builders
{
    public class ProcessoBuilder
    {
        public static void Build(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ProcessoModel>().Property(p => p.DataInicio).HasMaxLength(10);
            modelBuilder.Entity<ProcessoModel>().Property(p => p.DataFinalizacao).HasMaxLength(10);
