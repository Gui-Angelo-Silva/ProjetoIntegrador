...
namespace SGED.Controllers
{
    ...
    public class FiscalController : Controller
    {
        ...
        public async Task<ActionResult<IEnumerable<FiscalDTO>>> Get()
        {
            ...
            _response.Status = true; _response.Data = fiscalsDTO;
        ...
        public async Task<ActionResult<FiscalDTO>> Get(int id)
        {
            ...
            if (fiscalDTO == null)
            {
                _response.Status = false; _response.Message = "Fiscal não encontrado!"; _response.Data = fiscalDTO;
                return NotFound(_response);
            };

            _response.Status = true; _response.Message = "Fiscal " + fiscalDTO.NomePessoa + " obtido com sucesso."; _response.Data = fiscalDTO;
            return Ok(_response);
        }
        ...
        public async Task<ActionResult> Post([FromBody] FiscalDTO fiscalDTO)
        {
            if (fiscalDTO == null)
            {
                _response.Status = false; _response.Message = "Dado(s) inválido(s)!"; _response.Data = fiscalDTO;
            ...
            if (email == "" && cpfcnpj == "" && rgie == "")
            {
                ...
                _response.Status = true; _response.Message = "Fiscal " + fiscalDTO.NomePessoa + " cadastrado com sucesso."; _response.Data = fiscalDTO;
                return Ok(_response);
            }
            else
            {
        ...
        public async Task<ActionResult> Put([FromBody] FiscalDTO fiscalDTO)
        {
            ...
            {
                _response.Status = false; _response.Message = "O Fiscal informado não existe!"; _response.Data = fiscalDTO;
                return NotFound(_response);
            }
            ...
            if (email == "" && cpfcnpj == "" && rgie == "")
            {
                ...
                _response.Status = true; _response.Message = "Fiscal " + fiscalDTO.NomePessoa + " alterado com sucesso."; _response.Data = fiscalDTO;
                return Ok(_response);
            }
            else
            {
        ...
        public async Task<ActionResult<FiscalDTO>> Delete(int id)
        {
            ...
            _response.Status = true; _response.Message = "Fiscal " + fiscalDTO.NomePessoa + " excluído com sucesso."; _response.Data = fiscalDTO;
            return Ok(_response);
        }
