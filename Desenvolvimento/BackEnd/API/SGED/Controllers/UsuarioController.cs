    ...
    public class UsuarioController : Controller
    {
        ...
        public async Task<ActionResult> Post([FromBody] UsuarioDTO usuarioDTO)
        {
            ...
            try
            {
                ...
                {
                    _response.SetNotFound(); _response.Message = "O Tipo Usuário informado não existe!"; _response.Data = usuarioDTO;
                    return NotFound(_response);
                }
                ...
                if (usuariosDTO is not null && usuariosDTO.Any())
                {
        ...
        public async Task<ActionResult> Put([FromBody] UsuarioDTO usuarioDTO)
        {
            ...
            try
            {
                ...
                var usuariosDTO = await _usuarioService.GetAll();
                usuariosDTO = usuariosDTO.Where(u => u.Id != usuarioDTO.Id).ToList();
