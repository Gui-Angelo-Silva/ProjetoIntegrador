    ...
    <LayoutPage>
      ...
      <div className="flex relative justify-center items-center">
        ...
        <img
          ...
          className="cursor-pointer rounded-full w-[150px] h-[150px] object-cover border-[1px] border-[#dbdbdb] shadow-md"
      ...
      <div className="relative w-fit">
        <div className="flex items-center">
          <input type="text" className={`form-control rounded-md border-[#BCBCBC] text-[14px] text-[#636262] pr-12 ${inEdit ? "w-[260px]" : "w-[300px]"}`} readOnly={!inEdit} name="nomePessoa" placeholder="Informe o nome . . ." onChange={(e) => user.setPersonName(e.target.value)} value={user.personName} />
          {inEdit ?
            <>
      ...
      <br />
      <select className={`form-control rounded-md border-[#BCBCBC] text-[14px] text-[#636262] pr-12 ${inEdit ? "w-[260px]" : "w-[300px]"}`} onChange={(e) => user.setIdentifyCpfCnpj(e.target.value)} value={user.identifyCpfCnpj} >
      ...
      <br />
      <select className={`form-control rounded-md border-[#BCBCBC] text-[14px] text-[#636262] pr-12 ${inEdit ? "w-[260px]" : "w-[300px]"}`} onChange={(e) => user.setIdentifyRgIe(e.target.value)} value={user.identifyRgIe}>
