...
export default function CardIcon({ srcImage, title, module, onClick }) {
    ...
    const style = tv({
        base: "flex flex-col items-center justify-center w-[148px] h-[148px] transition ease-in-out delay-75 hover:scale-105 shadow-xl mb-3 mr-3 md:mr-6 rounded-xl text-lg font-semibold hover:text-white",
        variants: {
