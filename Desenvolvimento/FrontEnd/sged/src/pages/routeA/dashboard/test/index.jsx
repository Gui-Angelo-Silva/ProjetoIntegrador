                    ...
                    <div className="min-h-screen" style={{ flex: 2, marginLeft: '80px', marginRight: '40px', marginTop: -5 }}>
                        ...
                        <div className="flex">
                            <div className="pr-[50px]">
                                ...
                                <div className="grid grid-cols-2">
                                    <Link to="/a/development">
                                        <div className="flex flex-col items-center justify-center w-[148px] h-[148px] bg-[#c8d9db] hover:bg-[#58AFAE] shadow-xl hover:scale-105 mb-3 rounded-xl mr-4">
                                            <div className="text-lg font-semibold text-[#005A66]">Imóvel</div>
                                            <img src={ImgImovel} alt="Abrir tela de cadastro de imóvel" />
                                        </div>
                                    </Link>
                                    <Link to="/a/state">
                                        <div className="flex flex-col items-center justify-center w-[148px] h-[148px] bg-[#c8d9db] hover:bg-[#58AFAE] shadow-xl hover:scale-105 mb-2 rounded-xl">
                                            <div className="text-lg font-semibold text-[#005A66]">Estado</div>
                                            <img src={ImgEstado} alt="Abrir tela de cadastro de estado" />
                                        </div>
                                    </Link>
                                    <Link to="/a/city">
                                        <div className="flex flex-col items-center justify-center w-[148px] h-[148px] bg-[#c8d9db] hover:bg-[#58AFAE] shadow-xl hover:scale-105 mb-3 rounded-xl ">
                            ...
                            <div className="pr-[50px]">
                                ...
                                <div className="grid grid-cols-2">
                                    <Link to="/a/user">
                                        <div className="flex flex-col items-center justify-center w-[148px] h-[148px] bg-[#D1EBFE] hover:bg-[#91C9F4] shadow-xl hover:scale-105 mb-3 rounded-xl mr-4">
                                            <div className="text-lg font-semibold text-[#1D90E8]">Usuário</div>
                                            <img src={ImgUsuario} alt="" />
                                        </div>
                                    </Link>
                                    <Link to="/a/typeuser">
                                        <div className="flex flex-col items-center justify-center w-[148px] h-[148px] bg-[#D1EBFE] hover:bg-[#91C9F4] shadow-xl hover:scale-105 mb-2 rounded-xl">
                                            <div className="text-lg font-semibold text-[#1D90E8]">Tipo Usuário</div>
                                            <img src={ImgTipoUsuario} alt="" />
                                        </div>
                                    </Link>
                                    <Link to="/a/development">
                                        <div className="flex flex-col items-center justify-center w-[148px] h-[148px] bg-[#D1EBFE] hover:bg-[#91C9F4] shadow-xl hover:scale-105 mb-3 rounded-xl">
                            ...
                            <div className="">
                                ...
                                <div className="grid grid-cols-2">
                                    <Link to="/a/development">
                                        <div className="flex flex-col items-center justify-center w-[148px] h-[148px] bg-[#D6D3FA] hover:bg-[#A6A0F8] shadow-xl hover:scale-105 mb-3 rounded-xl mr-4">
                                            <div className="text-lg font-semibold text-[#4E42ED]">Processo</div>
                                            <img src={ImgProcesso} alt="" />
                                        </div>
                                    </Link>
                                    <Link to="/a/development">
                                        <div className="flex flex-col items-center justify-center w-[148px] h-[148px] bg-[#D6D3FA] hover:bg-[#A6A0F8] shadow-xl hover:scale-105 mb-2 rounded-xl">
                                            <div className="text-lg font-semibold text-[#4E42ED]">Tipo Processo</div>
                                            <img src={ImgTipoProcesso} alt="" />
                                        </div>
                                    </Link>
                                    <Link to="/a/development">
                                        <div className="flex flex-col items-center justify-center w-[148px] h-[148px] bg-[#D6D3FA] hover:bg-[#A6A0F8] shadow-xl hover:scale-105 mb-3 rounded-xl">
