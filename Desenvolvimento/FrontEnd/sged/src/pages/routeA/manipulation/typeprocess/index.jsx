...
export default function TypeProcess() {
    ...
    const PostTypeProcess = async () => {
        ...
        if (typeprocess.verifyData()) {
            const response = await connection.endpoint("TipoProcesso").postOrder(typeprocess);
    ...
    const PutTypeProcess = async () => {
        ...
        if (typeprocess.verifyData()) {
            const response = await connection.endpoint("TipoProcesso").putOrder(typeprocess);
    ...
    const DeleteTypeProcess = async () => {
        ...
        const response = await connection.endpoint("TipoProcesso").deleteOrder(typeprocess);
